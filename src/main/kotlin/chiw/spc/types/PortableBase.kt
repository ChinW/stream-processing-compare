...
abstract class PortableBase(val classId: ClassId) : DataIdentity<String>, Portable {
    private val log = LoggerFactory.getLogger(classId.name)
    var nid: String = ""

    override fun getFactoryId(): Int {
        return PortableTypeFactory.FACTORY_ID;
    }
    ...
    override fun readPortable(reader: PortableReader?) {
        if (reader != null) {
            ...
            this.nid = reader.readString("nid") ?: ""
        }
    }
    ...
    override fun writePortable(writer: PortableWriter?) {
        if (writer != null) {
                ...
                try {
                    ...
                    if (field[this] is Portable) {
                        ...
                        when (field.type) {
                            ...
                            Array<CommodityPortable>::class.java -> {
            ...
            writer.writeString("nid", this.getIdentity())
        }
    }
}